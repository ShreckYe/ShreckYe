...
- 🔭 ~I’m currently working on full-stack multiplatform app development with [Kotlin Multiplatform](https://kotlinlang.org/docs/multiplatform.html) (mainly [Vert.x](https://vertx.io/) and [Compose Multiplatform](https://www.jetbrains.com/lp/compose-multiplatform/)) in [@huanshankeji](https://github.com/huanshankeji).~ I'm currently taking a break from app development to focus on formalizing math with Lean 4 for [Project Numina](https://projectnumina.ai/).
